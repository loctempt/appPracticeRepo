...
//                startActivity(new Intent(getContext(), ));
    ...
    private class LogoutTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                mLogoutJson = new serverConnect(getContext()).runPost(UrlBase.BASE+"logout", "");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                if(mLogoutJson.getString("status").equals("ok")) {
                    Log.d(TAG, "onPostExecute: "+mLogoutJson.toString());
                    Toast.makeText(getContext(), mLogoutJson.getString("message"), Toast.LENGTH_SHORT).show();
    ...
    private class DoctorBrief {
        public DoctorBrief(String doctorId, String doctorJob, String doctorName, String doctorPositionalTitle) {
    ...
    private class DoctorsFetchTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                ...
                mDoctorsJson = new serverConnect(getContext()).runPost(UrlBase.BASE + "information/doctor_information_brief", "{\"doctorDepartment\":\"" + params[0] + "\"}");
            } catch (JSONException | IOException e) {
                e.printStackTrace();
            }
            return null;
    ...
    private class DoctorBriefHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            startActivity(detailInfoActivity.getIntent(getContext(), doctorId));
        }
    }
